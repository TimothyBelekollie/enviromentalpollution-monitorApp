                      ...
                      @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$editUser->name}}" placeholder="Enter full name">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email" value="{{$editUser->email}}" placeholder="Enter email">
                                @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" name="phone" value="{{$editUser->phone}}" placeholder="Phone number">
                                @error('phone')
